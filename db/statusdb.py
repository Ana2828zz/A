...
def CreateProfile(user: discord.Member, astrite, lustrous, radiant, resona):
    insert = {
        ...
        'pity4perlim': lustrous,
        'pity5perlim': radiant,
        'pity4armlim': lustrous,
        'pity5armlim': radiant,
        'pity4perilim': lustrous,
        'pity5perilim': radiant,
        'pity4armilim': lustrous,
        'pity5armilim': radiant,
...
def ConvenePerLim(user: discord.Member, banner):
    def Pity():
        ...
        if banner == 'perlim1':
            ...
            if result in itens["personagens"]:
                membstat.update_one(
            {
                '_id': user.id
            },
